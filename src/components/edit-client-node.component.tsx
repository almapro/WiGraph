...
export const EditClientNodeComponent = () => {
  ...
  const [client, setClient] = useState<ClientFormData>({
    ...
    name: isClient ? activeNode.data.name : "",
    macAddressParts: isClient
      ? activeNode.data.macAddress.split(":")
      : ["", "", "", "", "", ""],
    ipAddress: isClient ? activeNode.data.ip || "" : "",
    mobile: isClient ? activeNode.data.mobile : false,
    laptop: isClient ? activeNode.data.laptop : false,
    tablet: isClient ? activeNode.data.tablet : false,
    desktop: isClient ? activeNode.data.desktop : false,
  });
  ...
  const handleSubmit = async () => {
    try {
      ...
      await session.close();
      enqueueSnackbar("Client node updated successfully", {
        variant: "success",
      });
